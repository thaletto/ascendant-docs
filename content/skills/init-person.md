...
> This reader-facing page is maintained manually. The executable [`SKILL.md`](https://github.com/thaletto/ascendant-agents/blob/main/plugins/agent/ascendant/skills/init-person/SKILL.md) lives in the agents repository.
