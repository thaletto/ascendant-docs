...
> This reader-facing page is maintained manually. The executable [`SKILL.md`](https://github.com/thaletto/ascendant-agents/blob/main/plugins/agent/ascendant/skills/get-transit/SKILL.md) lives in the agents repository.

Read [`../../../AGENTS.md`](https://github.com/thaletto/ascendant-agents/blob/main/plugins/agent/AGENTS.md).
