...
function TabsContent({ className, ...props }: TabsPrimitive.Panel.Props) {
  return (
    <TabsPrimitive.Panel
      ...
      className={cn("flex flex-1 flex-col gap-4 text-sm outline-none", className)}
      {...props}
    />
  );
}
